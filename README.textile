...
bc.. tar zxvf rtaudio-<version>.tar.gz
cd rtaudio-<version>
./configure
make 
...
bc.. ./configure --enable-static --disable-shared --prefix=/tmp/unicap --disable-unicapgtk ; make ; make install
...
bc.. apt-get install libglfw-dev libglfw2
...
fn1. http://www.openframeworks.cc/forum/viewtopic.php?f=5&t=2097
